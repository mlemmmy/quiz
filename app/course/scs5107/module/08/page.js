  ...
  return (
    <main className="shell" data-course="scs5107">
      ...
      <header className="courseHead">
        ...
        <p>Work with cache headers, slim payloads, and GZip compression.</p>
      </header>
      <section className="notesGrid">
        <article className="note"><strong>Core focus</strong><p>Caching headers; payload reduction; GZip compression; response efficiency.</p></article>
